...
address: "Dept of Psychology, Columbia University in the City of New York"
www: monicathieu.com
...
In my PhD research, I use behavioral and fMRI research methods to investigate how people perceive and categorize various social (others' facial age and gender) and emotional (elicited experiences) stimuli.

In my teaching (so far), I particularly enjoy working with learners in introductory-level courses to in content (introductory psychology) and in methods (coding for behavioral sciences).
...
tribble(
  ...
  "PhD in Psychology", "expected 2022", "Columbia University", "New York, NY, USA",
...
tribble(
  ...
  "May 2015", "Honors thesis: Chronic media multitasking and distraction: Neural substrates and mnemonic consequences", "Advisors: Dr. Melina Uncapher, Dr. Anthony Wagner",
...
tribble(
  ...
  "May 2016", "Contestant", "500 Questions",
...
tribble(
  ...
  "[Carpentries](https://carpentries.org/)-certified instructor", "Fa2019-", "Introductory coding bootcamps", "[Columbia Foundations for Research Computing](https://rcfoundations.research.columbia.edu/)",
  "TA & guest lecturer", "Sp2019, Sp2020", "B8144: Intro to Programming in R", "Columbia Business School",
  "TA & section leader", "Fa2018, Fa2019", "PSYC 1490: Research Methods", "Columbia Dept of Psychology",
  "Curriculum developer & instructor", "Sp2018-", "[Intro to Programming for Social Scientists](https://cu-psych-computing.github.io/cu-psych-comp-tutorial/workshop/)", "Columbia Dept of Psychology",
