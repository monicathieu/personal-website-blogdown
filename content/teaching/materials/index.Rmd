...
blogdown::shortcode("figure",
                    src = "icds_syllabus_screenshot.png",
                    link = "https://sleepy-wing-5b36af.netlify.app/",
                    target = "https://sleepy-wing-5b36af.netlify.app/",
                    alt = "Intro to Programming for Behavioral Scientists syllabus",
                    width = "100%")
```
...
blogdown::shortcode("youtube",
                    id = "5wZRip70pV0",
                    title = "A tour of the visual system video")
```
