...
tribble(
  ~ Position, ~ Year, ~ Institution, ~ Where, ~ Why,
    "Postdoctoral fellow", "Aug 2022 - present", "Emory University", "Atlanta, GA, USA", c("Project: Subcortical pathways of looming and threat", "Supervisor: Dr. Philip Kragel", "Funding: [FIRST NIH IRACDA postdoctoral fellowship](https://med.emory.edu/education/postdoctoral-training/first/index.html) (100% salary support for 3 years)"),
...
tribble(
  ...
  "Senator & executive committee member", "2024 - present", "University Senate", "Emory University", "",
  "Chair", "2024 - present", "Emory Postdoctoral Association", "Emory University", "",
  "Executive Committee member", "2024 - present", "FIRST IRACDA program", "Emory University", "",
