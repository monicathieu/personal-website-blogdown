...
In my teaching (so far), I particularly enjoy working with learners in introductory-level courses in content (introductory psychology) and in methods (coding for behavioral sciences).
...
tribble(
  ...
  "PhD in Psychology", "expected 2022", "Columbia University", "New York, NY, USA", c("Proposed dissertation: 'Exploring perception and categorization of social and affective stimuli'", "Advisor: Dr. Kevin Ochsner", "Sep 2017 - completion expected May 2022"),
