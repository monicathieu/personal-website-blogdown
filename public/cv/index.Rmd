...
In my research, I use behavioral and fMRI research methods to investigate how people perceive and categorize various social (others' facial age and gender) and emotional (elicited experiences) stimuli.
...
tribble(
  ...
  "PhD in Psychology", "2022", "Columbia University", "New York, NY, USA", c("Dissertation: 'Exploring perception and categorization of social and affective stimuli'", "Advisor: Dr. Kevin Ochsner", "Sep 2017 - May 2022"),
...
tribble(
  ~ Name, ~ Year, ~ Position,
  "Lauren Wilkins", "2020-22", "Undergraduate research assistant & honors thesis student"
) %>% 
  brief_entries(
    what = Name,
    when = Year,
